...
const file_proto_user_proto_rawDesc = "" +
	...
	".user.User\x12'\n" +
	"\n" +
	"DeleteUser\x12\f.user.UserId\x1a\v.user.EmptyB1Z/github.com/bag-huyag/api-gateway/proto/gen/userb\x06proto3"
...
var file_proto_user_proto_depIdxs = []int32{
	...
	3, // 3: user.UserService.CreateUser:input_type -> user.NewUser
	2, // 4: user.UserService.UpdateUser:input_type -> user.User
	1, // 5: user.UserService.DeleteUser:input_type -> user.UserId
	4, // 6: user.UserService.GetUsers:output_type -> user.UserList
	2, // 7: user.UserService.GetUser:output_type -> user.User
	2, // 8: user.UserService.CreateUser:output_type -> user.User
